...
_export(exports, {
    get final_personality_verdict_prompt () {
        return final_personality_verdict_prompt;
    },
    get personality_questions_prompt () {
        return personality_questions_prompt;
    },
    get relationship_advice_system_prompt () {
        return relationship_advice_system_prompt;
    }
});
...
- If you believe the current user query can be answered based on your prior knowledge or previously retrieved context, you may respond directly.
...
- In such cases, include a special directive in your response:
...
Remember: You are not just an information provider. You are a **guide**, a **mirror**, and a **translator** of Enneagram wisdom into practical, human advice.
`;
...
//# sourceMappingURL=system_prompts_archive.js.map